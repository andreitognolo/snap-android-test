...
if [ ! -e ${INITIALIZATION_FILE} ]; then
  ...
  echo y | android update sdk --no-ui -a platform-tools > /dev/null
  echo y | android update sdk --no-ui -a tools > /dev/null

  # The BuildTools version used by your project
  echo y | android update sdk --no-ui -a build-tools-20.0.0 --all > /dev/null

  # The SDK version used to compile your project
  echo y | android update sdk --no-ui -a android-18 > /dev/null
  ...
  echo y | android update sdk --no-ui -a sys-img-armeabi-v7a-android-19 --all > /dev/null
